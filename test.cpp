...
int main() {
    ...
    Dish dish2("Beef Stew", {"Beef", "Potatoes", "Carrots", "Onions", "Garlic"}, 90, 20.99, Dish::CuisineType::AMERICAN); 
    Dish dish3("Tacos", {"Tortilla", "Beef", "Lettuce"}, 15, 9.99, Dish::CuisineType::MEXICAN);
    Dish dish4("Pizza", {"Dough", "Tomato Sauce", "Cheese"}, 30, 14.99, Dish::CuisineType::ITALIAN);  
